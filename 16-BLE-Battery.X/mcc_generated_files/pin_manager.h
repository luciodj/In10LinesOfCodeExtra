...
// get/set SW1 aliases
#define SW1_TRIS               TRISA5
#define SW1_LAT                LATA5
#define SW1_PORT               RA5
#define SW1_WPU                WPUA5
#define SW1_ANS                ANSA5
#define SW1_SetHigh()    do { LATA5 = 1; } while(0)
#define SW1_SetLow()   do { LATA5 = 0; } while(0)
#define SW1_Toggle()   do { LATA5 = ~LATA5; } while(0)
#define SW1_GetValue()         PORTAbits.RA5
#define SW1_SetDigitalInput()    do { TRISA5 = 1; } while(0)
#define SW1_SetDigitalOutput()   do { TRISA5 = 0; } while(0)

#define SW1_SetPullup()    do { WPUA5 = 1; } while(0)
#define SW1_ResetPullup()   do { WPUA5 = 0; } while(0)
#define SW1_SetAnalogMode()   do { ANSA5 = 1; } while(0)
#define SW1_SetDigitalMode()   do { ANSA5 = 0; } while(0)


// get/set CONN aliases
#define CONN_TRIS               TRISB0
#define CONN_LAT                LATB0
#define CONN_PORT               RB0
#define CONN_WPU                WPUB0
#define CONN_ANS                ANSB0
#define CONN_SetHigh()    do { LATB0 = 1; } while(0)
#define CONN_SetLow()   do { LATB0 = 0; } while(0)
#define CONN_Toggle()   do { LATB0 = ~LATB0; } while(0)
#define CONN_GetValue()         PORTBbits.RB0
#define CONN_SetDigitalInput()    do { TRISB0 = 1; } while(0)
#define CONN_SetDigitalOutput()   do { TRISB0 = 0; } while(0)

#define CONN_SetPullup()    do { WPUB0 = 1; } while(0)
#define CONN_ResetPullup()   do { WPUB0 = 0; } while(0)
#define CONN_SetAnalogMode()   do { ANSB0 = 1; } while(0)
#define CONN_SetDigitalMode()   do { ANSB0 = 0; } while(0)


// get/set SWAKE aliases
#define SWAKE_TRIS               TRISB1
#define SWAKE_LAT                LATB1
#define SWAKE_PORT               RB1
#define SWAKE_WPU                WPUB1
#define SWAKE_ANS                ANSB1
#define SWAKE_SetHigh()    do { LATB1 = 1; } while(0)
#define SWAKE_SetLow()   do { LATB1 = 0; } while(0)
#define SWAKE_Toggle()   do { LATB1 = ~LATB1; } while(0)
#define SWAKE_GetValue()         PORTBbits.RB1
#define SWAKE_SetDigitalInput()    do { TRISB1 = 1; } while(0)
#define SWAKE_SetDigitalOutput()   do { TRISB1 = 0; } while(0)

#define SWAKE_SetPullup()    do { WPUB1 = 1; } while(0)
#define SWAKE_ResetPullup()   do { WPUB1 = 0; } while(0)
#define SWAKE_SetAnalogMode()   do { ANSB1 = 1; } while(0)
#define SWAKE_SetDigitalMode()   do { ANSB1 = 0; } while(0)
...
// get/set CMD aliases
#define CMD_TRIS               TRISC7
#define CMD_LAT                LATC7
#define CMD_PORT               RC7
#define CMD_WPU                WPUC7
#define CMD_ANS                ANSC7
#define CMD_SetHigh()    do { LATC7 = 1; } while(0)
#define CMD_SetLow()   do { LATC7 = 0; } while(0)
#define CMD_Toggle()   do { LATC7 = ~LATC7; } while(0)
#define CMD_GetValue()         PORTCbits.RC7
#define CMD_SetDigitalInput()    do { TRISC7 = 1; } while(0)
#define CMD_SetDigitalOutput()   do { TRISC7 = 0; } while(0)

#define CMD_SetPullup()    do { WPUC7 = 1; } while(0)
#define CMD_ResetPullup()   do { WPUC7 = 0; } while(0)
#define CMD_SetAnalogMode()   do { ANSC7 = 1; } while(0)
#define CMD_SetDigitalMode()   do { ANSC7 = 0; } while(0)
