...
// get/set CD aliases
#define CD_TRIS               TRISB0
#define CD_LAT                LATB0
#define CD_PORT               RB0
#define CD_WPU                WPUB0
#define CD_ANS                ANSB0
#define CD_SetHigh()    do { LATB0 = 1; } while(0)
#define CD_SetLow()   do { LATB0 = 0; } while(0)
#define CD_Toggle()   do { LATB0 = ~LATB0; } while(0)
#define CD_GetValue()         PORTBbits.RB0
#define CD_SetDigitalInput()    do { TRISB0 = 1; } while(0)
#define CD_SetDigitalOutput()   do { TRISB0 = 0; } while(0)

#define CD_SetPullup()    do { WPUB0 = 1; } while(0)
#define CD_ResetPullup()   do { WPUB0 = 0; } while(0)
#define CD_SetAnalogMode()   do { ANSB0 = 1; } while(0)
#define CD_SetDigitalMode()   do { ANSB0 = 0; } while(0)
