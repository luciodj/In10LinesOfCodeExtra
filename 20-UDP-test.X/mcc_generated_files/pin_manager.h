...
// get/set CS aliases
#define CS_TRIS               TRISC2
#define CS_LAT                LATC2
#define CS_PORT               RC2
#define CS_WPU                WPUC2
#define CS_ANS                ANSC2
#define CS_SetHigh()    do { LATC2 = 1; } while(0)
#define CS_SetLow()   do { LATC2 = 0; } while(0)
#define CS_Toggle()   do { LATC2 = ~LATC2; } while(0)
#define CS_GetValue()         PORTCbits.RC2
#define CS_SetDigitalInput()    do { TRISC2 = 1; } while(0)
#define CS_SetDigitalOutput()   do { TRISC2 = 0; } while(0)

#define CS_SetPullup()    do { WPUC2 = 1; } while(0)
#define CS_ResetPullup()   do { WPUC2 = 0; } while(0)
#define CS_SetAnalogMode()   do { ANSC2 = 1; } while(0)
#define CS_SetDigitalMode()   do { ANSC2 = 0; } while(0)
